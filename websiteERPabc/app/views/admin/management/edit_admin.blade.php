...
<div class="row">
	<div class="col-xs-12">
		<div class="box box-primary">
			<!-- form start -->
				{{ Form::open(array('route' => array('doUpdateadmin', $data->id  ))) }}
				<div class="box-body">
					<div class="form-group">
						<label for="email">Tên đầy đủ</label>
						<div class="row">
							<div class="col-sm-6">
									{{ Form::text('name', $data->name, array('class' => 'form-control',  'placeholder'=> 'Tên đây đủ')) }}
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="row">
							<div class="col-sm-6">
									{{ Form::text('phone', $data->phone, array('class' => 'form-control',  'placeholder'=> 'Số điện thoại')) }}
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="row">
							<div class="col-sm-6">
									{{ Form::text('skyper', $data->skyper, array('class' => 'form-control',  'placeholder'=> 'skyper')) }}
							</div>
						</div>
					</div>
				</div>
