			...
			{{ Form::open(array('action' => array('ManagementController@update', $data->id), 'method' => 'PUT')) }}
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="row">
							<div class="col-sm-6">
								{{ Form::select('room_id', Department::lists('name', 'id'), $data->room_id, array('class' => 'form-control')) }}
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="row">
							<div class="col-sm-6">
								{{ Form::select('position_id', Regency::lists('name', 'id'), $data->position_id, array('class' => 'form-control')) }}
							</div>
						</div>
					</div>
				</div>
