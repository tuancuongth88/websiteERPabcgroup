...
<div class="row margin-bottom">
  <div class="col-xs-12">
    <a href="{{ action('ContractController@Appendix', $id) }}" class="btn btn-success">Danh sách</a>
  </div>
</div>
...
<div class="row">
	<div class="col-xs-12">
        ...
        <!-- form start -->
        {{ Form::open(array('action' => array('ContractController@storeAppendix', $id), 'method' => 'POST', 'files'=> true)) }}
          <div class="box-body">
            <div class="form-group">
              <label for="username">Parent</label>
              <div class="row">
                <div class="col-sm-6">
                    {{ Form::select('parent_id', Contract::where('id', $data->id)->lists('name', 'id'), null, array('class' => 'form-control')) }}
            ...
            <div class="form-group">
              <label>Số phụ lục</label>
               <div class="row">
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="code" placeholder="số phụ lục" name="code">
                    </div>
               </div>
            </div>
