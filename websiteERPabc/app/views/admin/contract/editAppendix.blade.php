...
<div class="row margin-bottom">
  <div class="col-xs-12">
    <a href="{{ action('ContractController@Appendix', $parent_id) }}" class="btn btn-success">Danh sách</a>
  </div>
</div>
...
<div class="row">
	<div class="col-xs-12">
        ...
        <!-- form start -->
        {{ Form::open(array('action' => array('ContractController@updateAppendix', $data->id), 'method' => 'POST', 'files'=> true)) }}
          <div class="box-body">
