...
class ButtonUserTableSeeder extends Seeder {
	...
	public function run()
	{
		$button = array('Thêm phòng ban','Sửa lương', 'Sửa hợp đồng', 'Sửa bằng cấp','Quản lý lương', 'Quản lý chức vụ', 'Quản lý phòng ban', 'Quản lý thể loại nhân viên', 'Quản lý nhân viên', 'Thể loại báo cáo', 'Thể loại thông báo', 'Chức năng phân quyền');
